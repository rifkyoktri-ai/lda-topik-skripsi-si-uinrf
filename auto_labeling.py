...
def label_topics_keybert(
    ...
    MANUAL_LABEL_OVERRIDE = {
        1: "Evaluasi Usability Sistem Informasi",
        2: "Evaluasi Kualitas Layanan (ServQual)",
        3: "Pengembangan Perangkat Lunak (SDLC/XP)",
        4: "Keamanan Sistem & Pengelolaan Arsip",
        5: "Evaluasi Kesuksesan & Adopsi Sistem Informasi",
        6: "End-User Computing Satisfaction (EUCS)",
        7: "Analitik Data, Prediksi & Manajemen Risiko IT",
        8: "Analisis Sentimen & Ulasan Pengguna",
    }
